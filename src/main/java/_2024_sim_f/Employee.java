...
public class Employee implements Serializable {
    ...
    public String toString() {
        return "Employee{name='%s', location='%s', shiftHours=%s, totalItemsSold=%s}".formatted(name, location, shiftHours, totalItemsSold);
    }

    public String getAsCSV(){
        return "%s, %s, %s, %s%n".formatted(name, location, shiftHours, totalItemsSold);
    }
