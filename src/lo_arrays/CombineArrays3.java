 ...
 *
 * The output should have sorted values in combined array
 *
 * Ex:
 * num1 : 5
 * num2 : 7
...
public class CombineArrays3 {
    ...
    public static void main(String[] args) {
        ...
        String output =  Arrays.toString(values2);
        System.out.println( output.substring(1, output.length()-1) );

        // System.out.println( Arrays.toString(combinedValues) );
        System.out.println( Arrays.toString(combinedValues).replace("[", "").replace("]", "") );
